...
public class DialogFragment extends Fragment implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
    ...
    @NonNull
    FragmentContainer a() {
        final FragmentContainer fragmentContainerA = super.a();
        return new FragmentContainer() { // from class: androidx.fragment.app.DialogFragment.5
            @Override // androidx.fragment.app.FragmentContainer
            @Nullable
            public View onFindViewById(int i) {
                return fragmentContainerA.onHasView() ? fragmentContainerA.onFindViewById(i) : DialogFragment.this.a(i);
            }

            @Override // androidx.fragment.app.FragmentContainer
            public boolean onHasView() {
                return fragmentContainerA.onHasView() || DialogFragment.this.b();
            }
        };
    }
    ...
    void a(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        if (this.G != null || this.mDialog == null || bundle == null || (bundle2 = bundle.getBundle(SAVED_DIALOG_STATE_TAG)) == null) {
            return;
        }
    ...
    public LayoutInflater onGetLayoutInflater(@Nullable Bundle bundle) {
        ...
        if (this.mShowsDialog && !this.mCreatingDialog) {
            ...
            return this.mDialog != null ? layoutInflaterOnGetLayoutInflater.cloneInContext(this.mDialog.getContext()) : layoutInflaterOnGetLayoutInflater;
        }
        if (FragmentManager.a(2)) {
    ...
    public void onSaveInstanceState(@NonNull Bundle bundle) {
        ...
        if (this.mDialog != null) {
            Bundle bundleOnSaveInstanceState = this.mDialog.onSaveInstanceState();
