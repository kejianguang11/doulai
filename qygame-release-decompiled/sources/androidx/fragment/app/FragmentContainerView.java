...
public final class FragmentContainerView extends FrameLayout {
    ...
    private void addDisappearingFragmentView(@NonNull View view) {
        if (this.mTransitioningFragmentViews == null || !this.mTransitioningFragmentViews.contains(view)) {
            return;
        }
    ...
    public WindowInsets dispatchApplyWindowInsets(@NonNull WindowInsets windowInsets) {
        WindowInsetsCompat windowInsetsCompat = this.mApplyWindowInsetsListener != null ? WindowInsetsCompat.toWindowInsetsCompat(this.mApplyWindowInsetsListener.onApplyWindowInsets(this, windowInsets)) : ViewCompat.onApplyWindowInsets(this, WindowInsetsCompat.toWindowInsetsCompat(windowInsets));
    ...
    protected boolean drawChild(@NonNull Canvas canvas, @NonNull View view, long j) {
        if (!this.mDrawDisappearingViewsFirst || this.mDisappearingFragmentChildren == null || this.mDisappearingFragmentChildren.size() <= 0 || !this.mDisappearingFragmentChildren.contains(view)) {
