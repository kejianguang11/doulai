...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView.OnItemSelectedListener {
    ...
    public void addTab(ActionBar.Tab tab, int i, boolean z) {
        TabView tabViewA = a(tab, false);
        this.b.addView(tabViewA, i, new LinearLayoutCompat.LayoutParams(0, -1, 1.0f));
        if (this.mTabSpinner != null) {
            ((TabAdapter) this.mTabSpinner.getAdapter()).notifyDataSetChanged();
        }
        if (z) {
            tabViewA.setSelected(true);
        }
    ...
    public void addTab(ActionBar.Tab tab, boolean z) {
        TabView tabViewA = a(tab, false);
        this.b.addView(tabViewA, new LinearLayoutCompat.LayoutParams(0, -1, 1.0f));
        if (this.mTabSpinner != null) {
            ((TabAdapter) this.mTabSpinner.getAdapter()).notifyDataSetChanged();
        }
        if (z) {
    ...
    public void animateToVisibility(int i) {
        ...
        viewPropertyAnimatorAlpha.setListener(this.f.withFinalVisibility(viewPropertyAnimatorAlpha, i));
