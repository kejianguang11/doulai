...
final class AppCompatReceiveContentHelper {
    ...
    static boolean a(@NonNull View view, @NonNull DragEvent dragEvent) {
        if (Build.VERSION.SDK_INT >= 24 && dragEvent.getLocalState() == null && ViewCompat.getOnReceiveContentMimeTypes(view) != null) {
            ...
            if (dragEvent.getAction() == 3) {
                return view instanceof TextView ? OnDropApi24Impl.a(dragEvent, (TextView) view, activityA) : OnDropApi24Impl.a(dragEvent, view, activityA);
            }
        }
        return false;
    }

    static boolean a(@NonNull TextView textView, int i) {
    ...
    @NonNull
    static InputConnectionCompat.OnCommitContentListener b(@NonNull final View view) {
