    ...
    */
    public boolean flagActionItems() {
        ...
        if (actionMenuPresenter.mStrictWidthLimit) {
            iA = i4 / actionMenuPresenter.mMinCellSize;
            i = ((i4 % actionMenuPresenter.mMinCellSize) / iA) + actionMenuPresenter.mMinCellSize;
        } else {
            iA = 0;
            i = 0;
        }
        ...
        while (i12 < size) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                ...
                if (r02.mStrictWidthLimit) {
                    iA -= ActionMenuView.a(itemView, i, iA, iMakeMeasureSpec, r3);
                } else {
                ...
                boolean z5 = (i9 > 0 || z4) && i11 > 0 && (!r02.mStrictWidthLimit || iA > 0);
                if (z5) {
                    boolean z6 = z5;
                    i2 = size;
                    ...
                    if (r02.mStrictWidthLimit) {
                        ...
                        z5 = z & (r02.mStrictWidthLimit ? i11 + i10 > 0 : i11 >= 0);
                    } else {
                        itemView2.measure(iMakeMeasureSpec, iMakeMeasureSpec);
                    }
                    z = z6;
                    int measuredWidth22 = itemView2.getMeasuredWidth();
                    i11 -= measuredWidth22;
                    if (i10 == 0) {
                    }
                    z5 = z & (r02.mStrictWidthLimit ? i11 + i10 > 0 : i11 >= 0);
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if (parcelable instanceof SavedState) {
            ...
            if (savedState.openSubMenuId <= 0 || (menuItemFindItem = this.c.findItem(savedState.openSubMenuId)) == null) {
                return;
            }
    ...
    public boolean onSubMenuSelected(SubMenuBuilder subMenuBuilder) {
        ...
        this.i = new ActionButtonSubmenu(this.b, subMenuBuilder, viewFindViewForItem);
