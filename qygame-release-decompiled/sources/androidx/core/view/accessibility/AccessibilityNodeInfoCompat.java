...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            return this.a == null ? accessibilityActionCompat.a == null : this.a.equals(accessibilityActionCompat.a);
        }
        ...
        public boolean perform(View view, Bundle bundle) {
            ...
            if (this.mViewCommandArgumentClass != null) {
                try {
                    AccessibilityViewCommand.CommandArguments commandArgumentsNewInstance = this.mViewCommandArgumentClass.getDeclaredConstructor(new Class[0]).newInstance(new Object[0]);
                    try {
    ...
    public void setTouchDelegateInfo(@NonNull TouchDelegateInfoCompat touchDelegateInfoCompat) {
        if (Build.VERSION.SDK_INT >= 29) {
            this.mInfo.setTouchDelegateInfo(touchDelegateInfoCompat.a);
        }
    }
