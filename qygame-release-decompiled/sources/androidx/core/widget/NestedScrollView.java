    ...
    */
    ...
    public void computeScroll() {
        ...
        if (i2 != 0) {
            ...
            int i3 = i2 - scrollY2;
            this.mScrollConsumed[1] = 0;
            dispatchNestedScroll(0, scrollY2, 0, i3, this.mScrollOffset, 1, this.mScrollConsumed);
            ...
            case 2:
                ...
                if (iFindPointerIndex == -1) {
                    ...
                    if (this.mIsBeingDragged) {
                        ...
                        if (a(0, i4, 0, getScrollY(), 0, scrollRange, 0, 0, true) && !hasNestedScrollingParent(0)) {
                            this.mVelocityTracker.clear();
                        }
                        int scrollY2 = getScrollY() - scrollY;
                        this.mScrollConsumed[1] = 0;
                        dispatchNestedScroll(0, scrollY2, 0, i4 - scrollY2, this.mScrollOffset, 0, this.mScrollConsumed);
                        ...
                        if (z2) {
                            ...
                            int i6 = scrollY + i5;
                            if (i6 < 0) {
                                EdgeEffectCompat.onPull(this.mEdgeGlowTop, i5 / getHeight(), motionEvent.getX(iFindPointerIndex) / getWidth());
                                if (!this.mEdgeGlowBottom.isFinished()) {
                                    edgeEffect = this.mEdgeGlowBottom;
                                ...
                                if (i6 > scrollRange) {
                                    EdgeEffectCompat.onPull(this.mEdgeGlowBottom, i5 / getHeight(), 1.0f - (motionEvent.getX(iFindPointerIndex) / getWidth()));
                                    if (!this.mEdgeGlowTop.isFinished()) {
                                        edgeEffect = this.mEdgeGlowTop;
                                        edgeEffect.onRelease();
                                    }
