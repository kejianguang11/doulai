...
public abstract class AutoScrollHelper implements View.OnTouchListener {
    ...
    private static class ClampedScroller {
        ...
        private float getValueAt(long j) {
            ...
            if (this.mStopTime < 0 || j < this.mStopTime) {
                return AutoScrollHelper.a((j - this.mStartTime) / this.mRampUpDuration, 0.0f, AutoScrollHelper.DEFAULT_RELATIVE_VELOCITY) * 0.5f;
            }
            return (AutoScrollHelper.DEFAULT_RELATIVE_VELOCITY - this.mStopValue) + (this.mStopValue * AutoScrollHelper.a((j - this.mStopTime) / this.mEffectiveRampDown, 0.0f, AutoScrollHelper.DEFAULT_RELATIVE_VELOCITY));
        }
        ...
        public void requestStop() {
            long jCurrentAnimationTimeMillis = AnimationUtils.currentAnimationTimeMillis();
            this.mEffectiveRampDown = AutoScrollHelper.a((int) (jCurrentAnimationTimeMillis - this.mStartTime), 0, this.mRampDownDuration);
    ...
    private float getEdgeValue(float f, float f2, float f3, float f4) {
        ...
        float fConstrainEdgeValue = constrainEdgeValue(f2 - f4, fA) - constrainEdgeValue(f4, fA);
    ...
    private void startAnimating() {
        ...
        if (this.mAlreadyDelayed || this.mActivationDelay <= 0) {
            ...
            ViewCompat.postOnAnimationDelayed(this.b, this.mRunnable, this.mActivationDelay);
        }
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        switch (motionEvent.getActionMasked()) {
            case 0:
                ...
                this.a.setTargetVelocity(computeTargetVelocity(0, motionEvent.getX(), view.getWidth(), this.b.getWidth()), computeTargetVelocity(1, motionEvent.getY(), view.getHeight(), this.b.getHeight()));
                if (!this.e && a()) {
                    startAnimating();
                }
                break;
