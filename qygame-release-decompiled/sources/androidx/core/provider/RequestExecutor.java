...
class RequestExecutor {
    ...
    static <T> T a(@NonNull ExecutorService executorService, @NonNull Callable<T> callable, @IntRange(from = 0) int i) throws InterruptedException {
        try {
    ...
    static Executor a(@NonNull Handler handler) {
        return new HandlerExecutor(handler);
    }

    static ThreadPoolExecutor a(@NonNull String str, int i, @IntRange(from = 0) int i2) {
    ...
    static <T> void a(@NonNull Executor executor, @NonNull Callable<T> callable, @NonNull Consumer<T> consumer) {
