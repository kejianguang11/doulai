...
public class FontsContractCompat {
    ...
    public static class FontFamilyResult {
        ...
        static FontFamilyResult a(int i, @Nullable FontInfo[] fontInfoArr) {
    ...
    public static class FontInfo {
        ...
        static FontInfo a(@NonNull Uri uri, @IntRange(from = 0) int i, @IntRange(from = 1, to = 1000) int i2, boolean z, int i3) {
