...
class VersionedParcelParcel extends VersionedParcel {
    ...
    protected VersionedParcel a() {
        return new VersionedParcelParcel(this.mParcel, this.mParcel.dataPosition(), this.mNextRead == this.mOffset ? this.mEnd : this.mNextRead, this.mPrefix + "  ", this.a, this.b, this.c);
    }
