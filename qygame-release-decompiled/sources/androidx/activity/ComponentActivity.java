...
public class ComponentActivity extends androidx.core.app.ComponentActivity implements OnBackPressedDispatcherOwner, ContextAware, ActivityResultCaller, ActivityResultRegistryOwner, HasDefaultViewModelProviderFactory, LifecycleOwner, ViewModelStoreOwner, SavedStateRegistryOwner {
    ...
    final ContextAwareHelper a;
    final SavedStateRegistryController b;
        ...
        getLifecycle().addObserver(new LifecycleEventObserver() { // from class: androidx.activity.ComponentActivity.4
            ...
            public void onStateChanged(@NonNull LifecycleOwner lifecycleOwner, @NonNull Lifecycle.Event event) {
                if (event == Lifecycle.Event.ON_DESTROY) {
                    ComponentActivity.this.a.clearAvailableContext();
    ...
    public final void addOnContextAvailableListener(@NonNull OnContextAvailableListener onContextAvailableListener) {
        this.a.addOnContextAvailableListener(onContextAvailableListener);
    }
    ...
    protected void onCreate(@Nullable Bundle bundle) {
        ...
        this.a.dispatchOnContextAvailable(this);
    ...
    public final Object onRetainNonConfigurationInstance() {
        ...
        nonConfigurationInstances2.a = objOnRetainCustomNonConfigurationInstance;
    ...
    public Context peekAvailableContext() {
        return this.a.peekAvailableContext();
    }
    ...
    public final void removeOnContextAvailableListener(@NonNull OnContextAvailableListener onContextAvailableListener) {
        this.a.removeOnContextAvailableListener(onContextAvailableListener);
    }
    ...
    public void reportFullyDrawn() {
        try {
            ...
            if (Build.VERSION.SDK_INT > 19 || (Build.VERSION.SDK_INT == 19 && ContextCompat.checkSelfPermission(this, "android.permission.UPDATE_DEVICE_STATS") == 0)) {
