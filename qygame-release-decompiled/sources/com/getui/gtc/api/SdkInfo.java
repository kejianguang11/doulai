...
public class SdkInfo implements Parcelable {
    ...
    private List<a.C0020a> stubs = new ArrayList();
    ...
    protected SdkInfo(Parcel parcel) {
        ...
        parcel.readTypedList(this.stubs, a.C0020a.CREATOR);
    }
    ...
    public void setStubs(List<a.C0020a> list) {
        this.stubs = list;
    }
