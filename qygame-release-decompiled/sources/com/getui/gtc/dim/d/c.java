...
public class c implements Parcelable {
    ...
    protected c(Parcel parcel) {
        try {
            this.parcelableClass = parcel.readString();
            Field declaredField = Class.forName(this.parcelableClass).getDeclaredField("CREATOR");
            declaredField.setAccessible(true);
            this.parcelables = new ArrayList();
            parcel.readTypedList(this.parcelables, (Parcelable.Creator) declaredField.get(null));
        } catch (Throwable th) {
            b.a(th);
        }
    }
