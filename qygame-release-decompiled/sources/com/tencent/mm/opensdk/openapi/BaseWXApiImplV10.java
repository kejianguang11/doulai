...
class BaseWXApiImplV10 implements IWXAPI {
        ...
        try {
            ...
            if (iWXChannelJumpInfo instanceof WXChannelBaseJumpInfo) {
                ...
                if (iWXChannelJumpInfo instanceof WXChannelJumpMiniProgramInfo) {
                    ...
                    str = Constant.PROTOCOL_WEB_VIEW_URL;
    ...
    public boolean registerApp(String str, long j) {
        ...
        c0055a.a = "com.tencent.mm";
        c0055a.b = ConstantsAPI.ACTION_HANDLE_APP_REGISTER;
        c0055a.c = "weixin://registerapp?appid=" + this.appId;
        c0055a.d = j;
        return a.a(this.context, c0055a);
    }
    ...
    public void unregisterApp() {
        ...
        a.C0055a c0055a = new a.C0055a();
        c0055a.a = "com.tencent.mm";
        c0055a.b = ConstantsAPI.ACTION_HANDLE_APP_UNREGISTER;
        c0055a.c = "weixin://unregisterapp?appid=" + this.appId;
        a.a(this.context, c0055a);
    }
}
