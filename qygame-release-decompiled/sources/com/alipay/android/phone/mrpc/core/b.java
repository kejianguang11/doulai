...
public final class b implements HttpClient {
    ...
    class a implements HttpRequestInterceptor {
        ...
        public final void process(HttpRequest httpRequest, HttpContext httpContext) {
            C0001b c0001b = b.this.f;
            if (c0001b != null && C0001b.a(c0001b) && (httpRequest instanceof HttpUriRequest)) {
                C0001b.a(c0001b, b.a((HttpUriRequest) httpRequest));
            }
        }
    }
    ...
    private static class C0001b {
        ...
        static /* synthetic */ void a(C0001b c0001b, String str) {
            Log.println(c0001b.b, c0001b.a, str);
        }

        static /* synthetic */ boolean a(C0001b c0001b) {
            return Log.isLoggable(c0001b.a, c0001b.b);
        }
    }
    ...
    private static boolean b(HttpUriRequest httpUriRequest) {
        ...
        Header[] headers2 = httpUriRequest.getHeaders(com.alipay.sdk.packet.d.d);
        if (headers2 != null) {
