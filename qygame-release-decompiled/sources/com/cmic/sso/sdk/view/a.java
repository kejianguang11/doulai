...
public class a {
    ...
    /* JADX INFO: renamed from: com.cmic.sso.sdk.view.a$a, reason: collision with other inner class name */
    ...
    public String C() {
        if (this.G) {
            this.F = this.at == 1 ? "請勾選同意服務條款" : this.at == 2 ? "Please check to agree to the terms of service" : "请勾选同意服务条款";
        }
        return this.F;
    }
    ...
    public String r() {
        if (this.u) {
            this.t = this.at == 1 ? "本機號碼登錄" : this.at == 2 ? "Login" : this.t;
        }
        return this.t;
    }
