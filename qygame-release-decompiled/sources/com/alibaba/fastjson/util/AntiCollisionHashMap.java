...
public class AntiCollisionHashMap<K, V> extends AbstractMap<K, V> implements Serializable, Cloneable, Map<K, V> {
    ...
    private void putForCreate(K k, V v) {
        K k2;
        int iHash = k == 0 ? 0 : hash(k instanceof String ? hashString((String) k) : k.hashCode());
    ...
    public V get(Object obj) {
        ...
        int iHash = hash(obj instanceof String ? hashString((String) obj) : obj.hashCode());
        for (Entry<K, V> entry = this.table[indexFor(iHash, this.table.length)]; entry != null; entry = entry.next) {
    ...
    final Entry<K, V> getEntry(Object obj) {
        K k;
        int iHash = obj == null ? 0 : hash(obj instanceof String ? hashString((String) obj) : obj.hashCode());
        for (Entry<K, V> entry = this.table[indexFor(iHash, this.table.length)]; entry != null; entry = entry.next) {
    ...
    public V put(K k, V v) {
        ...
        int iHash = hash(k instanceof String ? hashString((String) k) : k.hashCode());
        int iIndexFor = indexFor(iHash, this.table.length);
        for (Entry<K, V> entry = this.table[iIndexFor]; entry != null; entry = entry.next) {
    ...
    final Entry<K, V> removeEntryForKey(Object obj) {
        ...
        if (obj == null) {
            ...
            iHash = hash(obj instanceof String ? hashString((String) obj) : obj.hashCode());
        }
        int iIndexFor = indexFor(iHash, this.table.length);
    ...
    final Entry<K, V> removeMapping(Object obj) {
        ...
        if (key == null) {
            ...
            iHash = hash(key instanceof String ? hashString((String) key) : key.hashCode());
        }
        int iIndexFor = indexFor(iHash, this.table.length);
