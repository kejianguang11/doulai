...
public class MiscCodec implements ObjectDeserializer, ObjectSerializer {
    ...
    /* JADX WARN: Type inference failed for: r7v13, types: [T, java.text.SimpleDateFormat] */
    ...
    public <T> T deserialze(DefaultJSONParser defaultJSONParser, Type type, Object obj) {
        ...
        if (type != InetSocketAddress.class) {
            ...
            if (type == SimpleDateFormat.class) {
                ?? r7 = (T) new SimpleDateFormat(str, jSONLexer.getLocale());
                r7.setTimeZone(jSONLexer.getTimeZone());
                return r7;
            }
