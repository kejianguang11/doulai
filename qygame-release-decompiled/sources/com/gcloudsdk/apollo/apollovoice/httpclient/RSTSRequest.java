...
public class RSTSRequest {
        ...
        private void dealTask() {
            ...
            if (url == null) {
                ...
                if (httpURLConnection != null) {
                    ...
                    int i3 = i;
                    RSTSRequest.a(RSTSRequest.this);
                    RSTSRequest.response(RSTSRequest.this.mDelegate, i3, this.mTask.mSession, this.mTask.mSeq, this.mTask.mEnd, byteArrayOutputStream != null ? byteArrayOutputStream.toByteArray() : null);
                }
            ...
            int i32 = i;
            RSTSRequest.a(RSTSRequest.this);
            RSTSRequest.response(RSTSRequest.this.mDelegate, i32, this.mTask.mSession, this.mTask.mSeq, this.mTask.mEnd, byteArrayOutputStream != null ? byteArrayOutputStream.toByteArray() : null);
        }
    ...
    static /* synthetic */ int a(RSTSRequest rSTSRequest) {
    ...
    public int addTask(String str, String str2, String str3, String str4, int i, int i2, int i3) {
        ...
        this.mHttpCnt++;
        this.a.submit(new RunTask(rSTSHTTPTask));
        return 0;
    }
