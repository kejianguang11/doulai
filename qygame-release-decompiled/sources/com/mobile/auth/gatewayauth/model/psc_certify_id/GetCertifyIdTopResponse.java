...
public class GetCertifyIdTopResponse implements Jsoner {
    ...
    public void fromJson(JSONObject jSONObject) {
        try {
            ...
            if (jSONObject != null) {
                setResult((GetCertifyIdResult) JSONUtils.fromJson(jSONObject.optJSONObject(j.c), (JsonType) new JsonType<GetCertifyIdResult>() { // from class: com.mobile.auth.gatewayauth.model.psc_certify_id.GetCertifyIdTopResponse.1
                }, (List<Field>) null));
            }
        } catch (Throwable th) {
            try {
    ...
    public JSONObject toJson() {
        try {
            ...
            try {
                jSONObject.put(j.c, this.result == null ? new JSONObject() : this.result.toJson());
