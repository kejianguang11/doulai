...
public final class Util {
    ...
    public static final Comparator<String> NATURAL_ORDER = new Comparator<String>() { // from class: org.cocos2dx.okhttp3.internal.Util.1
    ...
    */
    ...
    public static ThreadFactory threadFactory(final String str, final boolean z) {
        return new ThreadFactory() { // from class: org.cocos2dx.okhttp3.internal.Util.2
