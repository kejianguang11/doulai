...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public RealWebSocket(Request request, WebSocketListener webSocketListener, Random random, long j) {
        ...
        this.writerRunnable = new Runnable() { // from class: org.cocos2dx.okhttp3.internal.ws.RealWebSocket.1
            @Override // java.lang.Runnable
            public void run() {
                do {
                    try {
    ...
    @Override // org.cocos2dx.okhttp3.WebSocket
    public void cancel() {
        this.call.cancel();
    }
    ...
    public void connect(OkHttpClient okHttpClient) {
        ...
        this.call.enqueue(new Callback() { // from class: org.cocos2dx.okhttp3.internal.ws.RealWebSocket.2
    ...
    @Override // org.cocos2dx.okhttp3.internal.ws.WebSocketReader.FrameCallback
    ...
    boolean writeOneFrame() throws IOException {
        ...
        synchronized (this) {
            ...
            if (byteStringPoll == null) {
                ...
                if (objPoll instanceof Close) {
                    ...
                    if (i != -1) {
                        ...
                        this.cancelFuture = this.executor.schedule(new CancelRunnable(), ((Close) objPoll).c, TimeUnit.MILLISECONDS);
                    }
                } else {
                    if (objPoll == null) {
                        return false;
            ...
            try {
                if (byteStringPoll != null) {
                    webSocketWriter.b(byteStringPoll);
                } else if (objPoll instanceof Message) {
                    ByteString byteString = ((Message) objPoll).b;
                    BufferedSink bufferedSinkBuffer = Okio.buffer(webSocketWriter.a(((Message) objPoll).a, byteString.size()));
