...
public final class Cookie {
    ...
    /* JADX WARN: Removed duplicated region for block: B:43:0x00ca A[PHI: r2
      0x00ca: PHI (r2v9 long) = (r2v1 long), (r2v6 long) binds: [B:42:0x00c8, B:53:0x00ec] A[DONT_GENERATE, DONT_INLINE]] */
    @Nullable
    /*
    ...
    */
    ...
    private static long parseExpires(String str, int i, int i2) {
        ...
        if (i4 >= 0 && i4 <= 69) {
            i4 += HonorResultCode.ADVANCED_RECORD_SUCCESS;
        }
        if (i4 < 1601) {
            throw new IllegalArgumentException();
        }
