...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    public static final class Builder {
        ...
        public Builder() {
            ...
            this.callTimeout = 0;
            this.connectTimeout = c.d;
            this.readTimeout = c.d;
            this.writeTimeout = c.d;
            this.pingInterval = 0;
        }
    ...
    static {
        Internal.instance = new Internal() { // from class: org.cocos2dx.okhttp3.OkHttpClient.1
    ...
    OkHttpClient(Builder builder) {
        ...
        if (builder.sslSocketFactory == null && z) {
            ...
            certificateChainCleaner = CertificateChainCleaner.get(x509TrustManagerPlatformTrustManager);
        } else {
