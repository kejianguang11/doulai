...
public final class CipherSuite {
    ...
    static final Comparator<String> ORDER_BY_NAME = new Comparator<String>() { // from class: org.cocos2dx.okhttp3.CipherSuite.1
    ...
    public static final CipherSuite TLS_RSA_WITH_SEED_CBC_SHA = init("TLS_RSA_WITH_SEED_CBC_SHA", b.as);
