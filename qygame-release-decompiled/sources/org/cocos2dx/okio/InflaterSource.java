...
public final class InflaterSource implements Source {
    ...
    public long read(Buffer buffer, long j) throws IOException {
        ...
        do {
            ...
            try {
                ...
                int iInflate = this.inflater.inflate(segmentWritableSegment.a, segmentWritableSegment.c, (int) Math.min(j, 8192 - segmentWritableSegment.c));
                if (iInflate > 0) {
                    segmentWritableSegment.c += iInflate;
                    long j2 = iInflate;
                    buffer.size += j2;
                    return j2;
                }
    ...
    public final boolean refill() throws IOException {
        ...
        this.bufferBytesHeldByInflater = segment.c - segment.b;
        this.inflater.setInput(segment.a, segment.b, this.bufferBytesHeldByInflater);
        return false;
    }
